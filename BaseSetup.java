...
public class BaseSetup {
	...
	public void setup() throws MalformedURLException {
		...
		caps.setCapability("appActivity", "com.example.roomexample.ActivityLogin");
	...
	public void test() throws InterruptedException {	//Test Cases
		...
		test_personelListesi();	// 2_1 - 2_5
		System.out.println("Personel listeleme kismi basarili");
	...
	public void testLogin() {	//giris ekraný ezcane ismi ve resmi duzenleme
		...
		MobileElement profil_resmi = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(By.xpath(
				"	\r\n"
				+ "//android.widget.LinearLayout[@content-desc=\"eczane.jpg, 51.69 kB, Dec 13, 2021\"]/android.widget.RelativeLayout/android.widget.FrameLayout[1]/android.widget.ImageView[1]")));
	...
	public void test_personelListesi() {
		String p1_ad = "Baþak";
		String p1_soyad = "Bal";
		String p2_ad = "Kayra";
		String p2_soyad = "Urfalý";
		String p3_ad = "Muhammed Baki";
		String p3_soyad = "Çaký";
		
		MobileElement personelListele = (MobileElement) wait.until(ExpectedConditions.elementToBeClickable(By.id("com.example.roomexample:id/nav_menu_employee_list")));
		personelListele.click();
		
	
		driver.findElementByAccessibilityId("More options").click();
		//Test Case: 2_1 ekle sil seceneklerinin oldugunun kontrolu
		try {
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView")));
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView")));
		}
		catch(Exception e) {
			System.out.println("Personel ekle - sil secenekleri cikmiyor!");
		}
		
		//Test Case: 2_2  ve 2_4 personel ekleme
		...
		//eksik bilgi ile personel kayit etme testi
		try {
		wait.until(ExpectedConditions.elementToBeClickable(By.id("com.example.roomexample:id/inputEmployeeFirstName"))).sendKeys("asd");
		driver.findElementById("com.example.roomexample:id/confirmButton").click();
		Thread.sleep(2000);
		String toastMessage = driver.findElementByXPath("/hierarchy/android.widget.Toast").getText();
		String expected = "Lütfen tüm alanlarý doldurduðunuzdan emin olunuz";
		assertEquals(expected, toastMessage);
		}
		catch(Exception e) {
			System.out.println("Eksik bilgi ile personel ekleme yapýlabiliyor!");
		}
		
		//Normal sekilde personel ekleme
		//1.personel
		wait.until(ExpectedConditions.elementToBeClickable(By.id("com.example.roomexample:id/inputEmployeeFirstName"))).sendKeys(p1_ad);
		driver.findElementById("com.example.roomexample:id/inputEmployeeLastName").sendKeys(p1_soyad);
		driver.findElementById("com.example.roomexample:id/confirmButton").click();
		...
		//2.personel
		driver.findElementByAccessibilityId("More options").click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.id("com.example.roomexample:id/inputEmployeeFirstName"))).sendKeys(p2_ad);
		driver.findElementById("com.example.roomexample:id/inputEmployeeLastName").sendKeys(p2_soyad);
		driver.findElementById("com.example.roomexample:id/confirmButton").click();
		...
		driver.findElementByAccessibilityId("More options").click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[1]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.id("com.example.roomexample:id/inputEmployeeFirstName"))).sendKeys(p3_ad);
		driver.findElementById("com.example.roomexample:id/inputEmployeeLastName").sendKeys(p3_soyad);
		driver.findElementById("com.example.roomexample:id/confirmButton").click();
		
		//Personel ekleme kontrolu
		try {
			String ilkSatir = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[1]/android.widget.TextView[2]").getText();
			String ikinciSatir = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[2]/android.widget.TextView[2]").getText();
			String ucuncuSatir = driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[3]/android.widget.TextView[2]").getText();
			assertEquals(ilkSatir, p1_ad+" " +p1_soyad);
			assertEquals(ikinciSatir, p2_ad+" "+p2_soyad);
			assertEquals(ucuncuSatir, p3_ad+" "+p3_soyad);
		}
		catch(Exception e) {
		...
		//Test Case: 2_3 ve 2_5 Personel silme
		driver.findElementByAccessibilityId("More options").click();
		wait.until(ExpectedConditions.elementToBeClickable(By.xpath("/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.LinearLayout[2]/android.widget.LinearLayout/android.widget.RelativeLayout/android.widget.TextView"))).click();
		wait.until(ExpectedConditions.elementToBeClickable(By.id("com.example.roomexample:id/inputEmployeeFirstName"))).sendKeys(p3_ad);
		driver.findElementById("com.example.roomexample:id/inputEmployeeLastName").sendKeys(p3_soyad);
		driver.findElementById("com.example.roomexample:id/confirmButton").click();
		driver.manage().timeouts().implicitlyWait(3, TimeUnit.SECONDS);//implicit wait
		...
		try {
			driver.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.view.ViewGroup/android.widget.FrameLayout[2]/android.view.ViewGroup/androidx.recyclerview.widget.RecyclerView/android.view.ViewGroup[3]/android.widget.TextView[2]");
			System.out.println("Personel silme basarisiz!");
		}
		catch(Exception e) {}	//beklenen	
	}
